...
Экономически и архитектурно выгодным решением оказалась **адаптация и патчинг самой библиотеки Twig** (собственный форк), сохранивший синтаксис 1.x при полной поддержке PHP 8.2–8.3:
