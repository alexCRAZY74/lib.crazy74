...
* `class.debug.php` — накопление отладочных данных, хронометраж исполнения и вывод отладочной панели.
* `class.console.php` — инструмент логирования в консоль браузера или изолированный файл лога.
